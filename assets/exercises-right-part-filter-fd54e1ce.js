var D=Object.defineProperty;var F=(e,t,s)=>t in e?D(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var $=(e,t,s)=>(F(e,typeof t!="symbol"?t+"":t,s),s);import{i as U,g as J,a as P,d as z,b as H,c as V,e as G,s as K,f as p}from"./vendor-295897c2.js";function Q(){document.querySelector(".filter-list-js").classList.add("hidden-form");const t=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",t.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const l="/energy_project/assets/sprite-c2a9f1af.svg",h=(e,t)=>e.length<=t?e:`${e.slice(0,t)}...`;function X(e){const t=document.querySelector(".filter-list-js");t.classList.remove("hidden-form"),e.length>6?t.classList.add("scroll"):t.classList.remove("scroll");const s=e.map(({_id:o,target:n,name:i,bodyPart:a,burnedCalories:r,time:L})=>`
  ...
  </button>`}function ge(e){const t=O(e==null?void 0:e.rating,0),s=Number.isFinite(t)?t.toFixed(1):"—";return`<div class="modal-info" data-id="${u(e==null?void 0:e._id,"")}">
      ...
      <div class="get-rating-choise">
        ...
        <form class="form raiting-form">
          ...
          <button class="raiting-form-submit" type="submit">Send</button>
  ...
  </div>`}function ve(){const e=document.querySelector(".rating-container-js"),t=e.querySelectorAll(".exercises_btn_start_icon_rating");let s=e.querySelector(".user-rating-js");t.forEach((a,r)=>{a.addEventListener("mouseover",()=>o(r)),a.addEventListener("mouseout",n),a.addEventListener("click",()=>i(r+1))});function o(a){n();for(let r=0;r<=a;r++)t[r].classList.add("hovered"),s.textContent=`${r+1}`}function n(){t.forEach(a=>{const r=e.dataset.rating;a.classList.remove("hovered"),s.textContent=`${r||0}`})}function i(a){e.setAttribute("data-rating",a),t.forEach((r,L)=>{L+1<=a?r.classList.add("selected"):r.classList.remove("selected")})}}let f=[];const g=JSON.parse(localStorage.getItem("favorites"));g!=null&&g.length&&f.push(...g);function ye(e){W(e),f.push(e),localStorage.setItem("favorites",JSON.stringify(f))}const N=e=>{ee(e),f=f.filter(t=>t._id!==e),localStorage.setItem("favorites",JSON.stringify([...f]))};p.settings({timeout:3e3,resetOnHover:!0,icon:"material-icons",transitionIn:"flipInX",transitionOut:"flipOutX",position:"topRight"});class _e{error(t){p.error({title:"Error",message:t})}success(t){p.success({title:"OK",message:t})}info(t){p.info({title:"Info",message:t})}}const S=new _e,be=document.querySelector(".filter-list-js");let I,x,R;async function Ee(e){e.preventDefault();const t=document.querySelector(".modal-get-raiting").dataset.id,o=document.querySelector(".rating-container-js").dataset.rating,n=document.querySelector(".raiting-form-field-input").value,i=document.querySelector(".raiting-form-field-comment").value,a={rate:Number(o),email:n,review:i};d.open();const r=await w.addExercisesRate(t,a);d.close(),r.message?S.error(`${r.message}`):(S.success(`Thank you for your mark - ${a.rate} for ${r.name}`),b.close())}async function Se(){const e=document.querySelector(".modal-info").dataset.id;b.close(),b.open(pe(e)),ve(),R=document.querySelector(".raiting-form"),R.addEventListener("submit",Ee)}async function we(e){const t=document.querySelector(".refresh-button-js"),s=document.querySelector(".modal-info").dataset.id;let n=window.location.href.toString().slice(-14);if(t.dataset.favorite==="false"){t.innerHTML=`<button class="add-favorite-js" type="button">
                                        <span class="remote-favorites">Remove from favorites</span>
                                    ...
                                    </button>`,t.dataset.favorite="false",N(s),n==="favorites.html"&&_()}function Le(e){var n,i,a;const t=e.target;if(t.classList.contains("favourites_btn_trash_icon")){const r=t.dataset.id||((i=(n=t.closest("[data-id]"))==null?void 0:n.dataset)==null?void 0:i.id);if(!r)return;N(r),_();return}const s=t.closest("[data-id]"),o=(a=s==null?void 0:s.dataset)==null?void 0:a.id;o&&(t.classList.contains("favourites_btn_workout")||$e(o))}be.addEventListener("click",Le);const $e=async e=>{if(!e)return;let t;try{d.open(),t=await w.getOneExercises(e)}catch(o){S.error((o==null?void 0:o.message)||String(o));return}finally{d.close()}if(!t){S.error("Exercise not found or request failed");return}let s=!1;try{const o=localStorage.getItem("favorites"),n=o?JSON.parse(o):[];s=Array.isArray(n)&&n.some(i=>(i==null?void 0:i._id)===e)}catch{s=!1}t.favorite=s,b.open(ge(t)),x=document.querySelector(".refresh-button-js"),I=document.querySelector(".add-rating"),I&&I.addEventListener("click",Se),x&&x.addEventListener("click",we)};export{h as a,me as c,w as f,d as l,S as m,l as s};
//# sourceMappingURL=exercises-right-part-filter-fd54e1ce.js.map
